...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      {/* Chatbot Section */}
      <section className="w-full py-4 md:py-8 lg:py-16 bg-white">
        <div className="container px-4 md:px-6 mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">CHN ENG translator</h2>
          <div className="w-full max-w-4xl mx-auto">
            <iframe
              src="https://udify.app/chatbot/MAKmH8wh9A7XKHuB"
